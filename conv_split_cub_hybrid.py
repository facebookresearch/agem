    ...
    for imp_method in models_list:
        ...
        for synap_stgth in synap_stgth_list:
            for lr in learning_rate_list:
                ...
                experiment_id = "SPLIT_CUB_HERDING_%r_HYB_%r_%s_%r_%r_%s_%s_%s_%r_%s-"%(args.is_herding, args.set_hybrid, args.arch, args.eval_single_head, args.train_single_epoch, imp_method, 
